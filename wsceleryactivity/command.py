...
from wsceleryactivity.app import WsCeleryActivity
from wsceleryactivity.options import default_options

logger = logging.getLogger(__name__)


class WsCeleryActivityCommand(Command):
    ENV_VAR_PREFIX = 'WSCELERYACTIVITY_'
    ...
    def run_from_argv(self, prog_name, argv=None, **kwargs):
        ...
        wscelery = WsCeleryActivity(capp=self.app, options=options or default_options)
        # Graceful exit
